...
const Nav = () => {
    return (
        <>
            ...
            <nav class="navbar navbar-expand-lg navbar-light" style={{ backgroundColor: 'white',marginBottom:'780px',width:'1525px',marginLeft:'-155px',display:'flex',marginTop:'-30px' }}>
                <div class="container-fluid">
                    <a class="navbar-brand ms-5" style={{ fontWeight: '700',color:'red',marginRight:'200px',justifyContent:'space-evenly' }} href="#"><b>RealEstate</b></a>
